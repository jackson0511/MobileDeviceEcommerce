        ...
        <div class="col-lg-8">
            <div class="card-box">
                ...
                @if(count($errors)>0)
                    ...
                    <form action="admin/anhslidesanpham/them" method="post" data-parsley-validate novalidate enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="form-group">
                            <label for="userName">Ảnh trên</label>
                            <input type="file" name="anhtren" class="filestyle" data-buttonbefore="true">
                        </div>
                        <div class="form-group">
                            <label for="userName">Ảnh dưới</label>
                            <input type="file" name="anhduoi" class="filestyle" data-buttonbefore="true">
                        </div>
                        <div class="form-group">
