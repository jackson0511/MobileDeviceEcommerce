        ...
        <div class="col-lg-10">
            <div class="card-box">
                ...
                @if(count($errors)>0)
                    ...
                    <form action="admin/banner/sua/{{$banner->id}}" method="post" data-parsley-validate novalidate enctype="multipart/form-data" >
                        {{csrf_field()}}
                        <div class="form-group">
                            <label for="userName">Tên</label>
                            <input type="text" name="ten" parsley-trigger="change" required  placeholder="Nhập tên banner" value="{{$banner->Ten }}" class="form-control" >
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <img width="200px" src="upload/banner/{{$banner->Hinh}}" alt="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group text-right m-b-0">
                            ...
                            <button type="reset" class="btn btn-default waves-effect waves-light m-l-5 button">
                                <a href="admin/banner/danhsach">Cancel</a>
                            </button>
                        </div>
