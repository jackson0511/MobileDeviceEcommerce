    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card-box">
                ...
                <form action="admin/baohanh/them" method="post" data-parsley-validate novalidate>
                    {{csrf_field()}}
                    <div class="form-group">
                        <label for="userName">Tên</label>
                        <input type="text" name="ten" parsley-trigger="change"   placeholder="Nhập tên bảo hành" class="form-control" >
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group ">
                        ...
                        @foreach($optionbaohanh as $opbh)
                            <input type="checkbox" class="form-group thuoctinh " name="option[]" value="{{$opbh->id}}">
                            {{$opbh->Ten}}
                        @endforeach
                    </div>
