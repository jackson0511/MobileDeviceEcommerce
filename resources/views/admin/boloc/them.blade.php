    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card-box">
                ...
                <form action="admin/boloc/them" method="post" data-parsley-validate novalidate>
                    {{csrf_field()}}
                    <div class="form-group">
                        <label for="userName">Tên</label>
                        <input type="text" name="ten" parsley-trigger="change"   placeholder="Nhập tên bộ lọc" class="form-control" >
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" name="parent_id" id="parent_id">
                            ...
                            @foreach($boloc as $bl)
                                <option value="{{$bl->id}}">{{$bl->Ten}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
