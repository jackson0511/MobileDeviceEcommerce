        ...
        <div class="col-lg-8">
            <div class="card-box">
                ...
                @if(count($errors)>0)
                    ...
                    <form action="admin/danhmucsanpham/sua/{{$danhmucsanpham->id}}" method="post" data-parsley-validate novalidate>
                        {{csrf_field()}}
                        <div class="form-group">
                            <label for="userName">Tên </label>
                            <input type="text" name="ten" parsley-trigger="change"   placeholder="Nhập tên sản phẩm" value="{{ $danhmucsanpham->Ten }}" class="form-control" >
                        </div>
