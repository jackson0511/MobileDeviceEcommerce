        ...
        <div class="col-lg-8">
            <div class="card-box">
                ...
                @if(count($errors)>0)
                    ...
                    <form action="admin/gialinhkien/sua/{{$gialinhkien->id}}" method="post" data-parsley-validate novalidate>
                        {{csrf_field()}}
                        <div class="form-group">
                            <label for="userName">Tên linh kiện</label>
                            <input type="text" name="ten" parsley-trigger="change"   placeholder="Nhập tên linh kiện" value="{{ $gialinhkien->Ten_LinhKien }}" class="form-control" >
                        </div>
                        <div class="form-group">
                            <label for="userName">Giá</label>
                            <input type="text" name="gia" parsley-trigger="change"   placeholder="Nhập giá" value="{{$gialinhkien->Gia_Sua}}" class="form-control" >
                        </div>
                        <div class="form-group">
                            <label for="userName">Số lượng</label>
                            <input type="text" name="soluong" parsley-trigger="change"   placeholder="Nhập số lượng" value="{{$gialinhkien->SoLuong }}" class="form-control" >
                        </div>
                        <div class="form-group">
