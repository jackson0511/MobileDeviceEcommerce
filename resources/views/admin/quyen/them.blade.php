    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card-box">
                ...
                <form action="admin/quyen/them" method="post" data-parsley-validate novalidate>
                    {{csrf_field()}}
                        <div class="form-group">
                            <label for="userName">Tên thể loại</label>
                            <input type="text" name="ten" parsley-trigger="change" required  placeholder="Nhập tên quyền" value="{{old('ten')}}" class="form-control" >
                        </div>
