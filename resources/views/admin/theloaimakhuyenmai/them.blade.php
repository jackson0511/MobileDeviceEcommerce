    ...
    <div class="row">
        <div class="col-lg-10">
            <div class="card-box">
                ...
                <form action="admin/theloaimakhuyenmai/them" method="post" data-parsley-validate novalidate >
                    {{csrf_field()}}
                    <div class="form-group">
                        <label for="userName">Tên</label>
                        <input type="text" name="ten" parsley-trigger="change"   placeholder="Nhập tên mã khuyến mãi" value="{{ old('ten') }}" class="form-control" >
                    </div>
                    <div class="form-group">
                        <label for="userName">Code</label>
                        <input type="text" name="code" parsley-trigger="change"   placeholder="Nhập mã khuyến mãi" value="{{ old('code') }}" class="form-control" >
                    </div>
                    <div class="form-group">
                        <label>Ngày Áp Dụng</label>
                        <div class="input-group">
                            <input type="text" class="form-control" name="ngayapdung" value="{{old('ngayapdung')}}" placeholder="mm/dd/yyyy" id="datepicker">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="giatri" parsley-trigger="change"   placeholder="Nhập giá trị" value="{{ old('giatri') }}" class="form-control" >
                    </div>
                    <div class="form-group">
