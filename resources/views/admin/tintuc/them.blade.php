    ...
    <div class="row">
        <div class="col-lg-10">
            <div class="card-box">
                ...
                <form action="admin/tintuc/them" method="post" data-parsley-validate novalidate enctype="multipart/form-data" >
                    {{csrf_field()}}
                    <div class="form-group">
                        <label for="userName">Tên</label>
                        <input type="text" name="ten" parsley-trigger="change" required  placeholder="Nhập tên tin tức" value="{{ old('ten') }}" class="form-control" >
                    </div>
                    <div class="form-group">
