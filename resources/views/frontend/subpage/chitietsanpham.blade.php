...
{{--            @if($ngay>=$km->khuyenmai->NgayBatDat && $ngay<=$km->khuyenmai->NgayKetThuc &&--}}
{{--              $km->khuyenmai->TrangThai==1)--}}
{{--              <del><span class="regular">{{formatPrice($sanpham->Gia)}}</span></del>--}}
{{--              <ins><span class="amount">{{formatPrice(($sanpham->GiaSale))}}</span></ins>--}}
{{--            @elseif($km->khuyenmai->TrangThai==1)--}}
{{--               <del><span class="regular">{{formatPrice($sanpham->Gia)}}</span></del>--}}
{{--            @endif--}}
{{--          @endforeach--}}
{{--      @else--}}
