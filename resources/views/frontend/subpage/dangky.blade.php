                ...
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <form method="post" action="dangky">
                      ...
                      <div class="form-group">
                        ...
                        name="email"aria-describedby="emailHelp" placeholder="vui lòng nhập email"
                        >
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputAddress" placeholder="vui lòng nhập tên" name="name">
                    </div>
                    <div class="form-group">
                        <label for="inputAddress">Address</label>
                        <input type="text" class="form-control" id="inputAddress" placeholder="vui lòng nhập địa chỉ" name="diachi">
                    </div>
                    <div class="form-group">
                        <label for="inputAddress">Phone</label>
                        <input type="text" class="form-control" id="inputAddress" placeholder="vui lòng nhập số điện thoại" name="sdt">
                    </div>
